...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post prescriptions_url, params: { prescription: { name: @prescription.name, note: @prescription.note, patient_id: @prescription.patient_id } }
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { name: @prescription.name, note: @prescription.note, patient_id: @prescription.patient_id } }
